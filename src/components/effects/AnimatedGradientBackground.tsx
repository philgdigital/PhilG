...
export function AnimatedGradientBackground() {
  return (
    <div className="fixed inset-0 z-[-2] overflow-hidden bg-[#0a0a0c]">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[60vw] h-[60vw] rounded-full bg-[#0f62fe]/28 mix-blend-screen filter blur-[110px] md:blur-[150px] animate-blob-a" />
      <div className="absolute top-[20%] right-[-10%] w-[50vw] h-[50vw] rounded-full bg-[#10b981]/22 mix-blend-screen filter blur-[110px] md:blur-[150px] animate-blob-b" />
      <div className="absolute bottom-[-20%] left-[20%] w-[70vw] h-[70vw] rounded-full bg-[#0f62fe]/10 mix-blend-screen filter blur-[120px] md:blur-[160px] animate-blob-c" />
      <div className="absolute bottom-[10%] right-[10%] w-[40vw] h-[40vw] rounded-full bg-[#10b981]/11 mix-blend-screen filter blur-[100px] md:blur-[140px] animate-blob-d" />
