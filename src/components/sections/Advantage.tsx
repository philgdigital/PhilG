...
export function Advantage() {
  return (
    <section
      id="advantage"
      className="py-24 px-6 md:px-12 lg:px-24 relative z-10 border-t border-white/5 bg-gradient-to-b from-neutral-950/80 to-transparent"
    >
      <Reveal>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
        ...
        <div className="flex flex-col gap-10">
          ...
          <TiltCard
            scale={1.05}
            maxRotation={5}
            className="glass p-8 rounded-3xl border-cyan-500/10 hover:border-cyan-500/30 group relative"
          >
            <ElectricBorder />
            <Reveal delay={300}>
              <div className="flex gap-6 relative z-10">
