...
const CARDS: ExpertiseCard[] = [
  {
    ...
    desc: "Hiring, coaching, and leading high-performing design teams. At Kuoni Tumlare I hired six UX designers and led a twelve-person team in Prague. Mentored 1,050+ designers who've led at hundreds of firms, including Meta, Booking.com, Uber, IBM, Accenture, SAP, Thoughtworks, Zalando, and Kuoni Tumlare across 11 countries.",
  },
  {
      ...
      <Reveal>
        <div className="flex items-center gap-4 mb-16">
          ...
          <h2 className="font-mono text-xs md:text-sm font-medium tracking-[0.22em] uppercase text-zinc-400">
            <span className="text-zinc-400">04 ·</span> Full-Stack Capabilities
          </h2>
        </div>
      </Reveal>
