              ...
              <div className="md:sticky md:top-0 md:h-screen md:flex md:items-center md:order-1">
                <Reveal direction="left" className="w-full">
                  <TiltCard scale={1.02} maxRotation={4} className="w-full">
                    <div
                      data-card="true"
                      className="group relative w-full rounded-[2rem] md:rounded-[2.5rem] bg-black/50 border border-white/5 hover-target overflow-hidden aspect-[4/5] md:aspect-[5/6] transition-all duration-700 hover:border-white/15 shadow-2xl"
                    >
                      <ElectricBorder />
                      <ParallaxImage
                        src={p.img}
                ...
                <Reveal delay={240}>
                  <dl className="grid grid-cols-2 gap-x-8 gap-y-6 max-w-md mt-2">
                    <div className="flex flex-col gap-1.5">
                      <dt className="font-mono text-[10px] font-medium tracking-[0.22em] uppercase text-zinc-500">
                        Role
                      </dt>
