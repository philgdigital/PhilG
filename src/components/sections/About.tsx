            ...
            <TiltCard scale={1.02} maxRotation={5}>
              <div className="relative rounded-[2rem] overflow-hidden aspect-[4/5] border border-white/10 group bg-zinc-900/50">
                ...
                <Image
                  ...
                  priority
                  quality={90}
                  className="object-cover object-top grayscale-[0.4] opacity-90 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700 ease-[var(--ease-out)] transform group-hover:scale-105"
                />
